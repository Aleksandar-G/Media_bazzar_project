...
namespace MediaBazaar.Models
{
    class Manager : User
    {
        ...
        public Manager(string name, string email, string phone, decimal salary, DateTime birthday, DateTime startDate, DateTime endDate) 
            : base(name, email, phone, "Manager", salary, birthday, startDate, endDate)
        {
            this.userId = base.Id;
        }
